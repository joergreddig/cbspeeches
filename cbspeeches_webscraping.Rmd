...
# for which range is this function?
...
# get list of links to speeches 2006-2011 without 2007, and 2010
ecb_links <- map_df(2005, get_speech_list_ecb)
...
ecb_speeches <- map_df(1:nrow(ecb_links), scrape_ecb_2006) 


# add date column to speeches vector
ecb_speeches <- cbind(ecb_links[, 2], ecb_speeches)
...
for (i in 1:nrow(ecb_speeches)) {
    ...
    } else if (str_detect(ecb_speeches$subtitle[i], "Lucas Papademos")) {
