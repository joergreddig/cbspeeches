...
temp <- ecb_speeches %>% 
    ...
    mutate(institution = "ECB",
           ...
           source = "") %>%
    select(doc_id, date, speaker, city, country, subtitle, title, length, words_per_sentence, characters_per_word, flesch, flesch_grade, language, institution, link, source) # %>% 
