...
#### need to get rid of non-english speeches!
    # only delete if there is an english version available
    # extract speech language in new column
...
speeches_to_file <- function(i) {
    write(ecb_speeches$text[i], file = paste0(ecb_speeches$date[i], " - ECB - Name", ".txt"))
}
